...
const accordionTriggerStyle = tva({
  base: 'web:outline-none w-full flex-row items-center justify-between px-5 py-5 focus:outline-none data-[focus-visible=true]:bg-background-50 data-[disabled=true]:cursor-not-allowed data-[disabled=true]:opacity-40',
});
