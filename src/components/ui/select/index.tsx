...
const selectTriggerStyle = tva({
  ...
  variants: {
    ...
    variant: {
      underlined:
        'data-[focus=true]:web:shadow-[inset_0_-1px_0_0] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:web:shadow-error-700 rounded-none border-0 border-b data-[invalid=true]:border-error-700 data-[focus=true]:border-primary-700 data-[hover=true]:border-primary-700',
      outline:
        'data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:data-[hover=true]:web:shadow-primary-600 data-[invalid=true]:web:shadow-[inset_0_0_0_1px] data-[invalid=true]:web:shadow-error-700 data-[invalid=true]:border-error-700 data-[invalid=true]:data-[hover=true]:border-error-700 data-[focus=true]:border-primary-700',
      rounded:
        'data-[focus=true]:web:shadow-[inset_0_0_0_1px] data-[focus=true]:web:shadow-primary-700 data-[invalid=true]:web:shadow-error-700 rounded-full data-[invalid=true]:border-error-700 data-[focus=true]:border-primary-700',
    },
  },
});

const selectInputStyle = tva({
  base: 'py-auto web:w-full web:outline-none ios:leading-[0px] pointer-events-none h-full px-3 text-typography-900 placeholder:text-typography-500',
  parentVariants: {
    size: {
      xl: 'text-xl',
      lg: 'text-lg',
