...
const actionsheetContentStyle = tva({
  base: 'web:pointer-events-auto web:select-none items-center rounded-tl-3xl rounded-tr-3xl bg-background-0 p-2 shadow-lg',
});

const actionsheetItemStyle = tva({
  base: 'data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed web:data-[focus-visible=true]:bg-background-100 w-full flex-row items-center rounded-sm p-3 hover:bg-background-50 active:bg-background-100 data-[checked=true]:bg-background-100 data-[focus=true]:bg-background-100 data-[disabled=true]:opacity-40',
});
