...
import { Platform, Pressable, Text , Text } from 'react-native';
...
const linkTextStyle = tva({
  base: 'font-body web:font-sans web:tracking-sm web:my-0 web:bg-transparent web:border-0 web:box-border web:display-inline web:list-none web:margin-0 web:padding-0 web:position-relative web:text-start web:whitespace-pre-wrap web:word-wrap-break-word font-normal text-info-700 underline data-[hover=true]:text-info-600 data-[hover=true]:no-underline data-[active=true]:text-info-700',
