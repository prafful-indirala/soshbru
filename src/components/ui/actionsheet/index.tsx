...
const actionsheetContentStyle = tva({
  base: 'web:pointer-events-auto web:select-none shadow-hard-5 items-center rounded-tl-3xl rounded-tr-3xl border border-b-0 border-outline-100 bg-background-0 p-5 pt-2',
});

const actionsheetItemStyle = tva({
  base: 'data-[disabled=true]:web:pointer-events-auto data-[disabled=true]:web:cursor-not-allowed web:data-[focus-visible=true]:bg-background-100 web:data-[focus-visible=true]:outline-indicator-primary w-full flex-row items-center gap-2 rounded-sm p-3 hover:bg-background-50 active:bg-background-100 data-[focus=true]:bg-background-100 data-[disabled=true]:opacity-40',
});
...
const actionsheetBackdropStyle = tva({
  base: 'web:cursor-default web:pointer-events-auto absolute bottom-0 left-0 right-0 top-0 bg-background-dark',
});
