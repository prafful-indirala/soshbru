...
const fabStyle = tva({
  base: 'group/fab disabled:pointer-events-all data-[focus=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[focus-visible=true]:web:ring-indicator-info shadow-hard-2 absolute z-20 flex-row items-center justify-center rounded-full bg-primary-500 p-4 hover:bg-primary-600 active:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-40',
  variants: {
    size: {
      sm: 'px-2.5 py-2.5',
      md: 'px-3 py-3',
