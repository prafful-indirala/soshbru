...
import { Platform, Pressable, View , View, Platform } from 'react-native';
...
const sliderThumbStyle = tva({
  base: 'web:cursor-pointer web:active:outline-4 web:active:outline web:active:outline-primary-400 data-[focus=true]:web:outline-4 data-[focus=true]:web:outline data-[focus=true]:web:outline-primary-400 shadow-hard-1 absolute rounded-full bg-primary-500 data-[focus=true]:bg-primary-600 data-[hover=true]:bg-primary-600 data-[active=true]:bg-primary-600 data-[disabled=true]:bg-primary-500',
