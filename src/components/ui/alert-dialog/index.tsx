...
const alertDialogCloseButtonStyle = tva({
  base: 'group/alert-dialog-close-button web:cursor-pointer z-10 rounded-sm p-2 outline-0 data-[focus-visible=true]:bg-background-100',
});
...
const alertDialogBackdropStyle = tva({
  base: 'web:cursor-default absolute bottom-0 left-0 right-0 top-0 bg-background-dark',
});
